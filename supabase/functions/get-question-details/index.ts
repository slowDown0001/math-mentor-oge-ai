...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Topic-skill mapping to derive topics from skills
    const topicSkillMapping = [
      { topic: "1.1", skills: [1, 2, 3, 4, 5] },
      { topic: "1.2", skills: [6, 7, 8, 9, 10] },
      { topic: "1.3", skills: [11, 12, 13, 14, 15, 16, 17, 180] },
      { topic: "1.4", skills: [18, 19, 20] },
      { topic: "1.5", skills: [21, 22] },
      { topic: "1.6", skills: [23, 24, 25, 26, 27] },
      { topic: "2.1", skills: [28, 29, 30, 31, 32, 33] },
      { topic: "2.2", skills: [34, 35, 36, 37, 38, 39, 40] },
      { topic: "2.3", skills: [41, 42, 43] },
