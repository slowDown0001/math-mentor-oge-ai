...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { user_id, diagnostic_test_oge_result }: RequestBody = await req.json()
    ...
    console.log(`Initializing priors for user ${user_id}`, {
    ...
    // Initialize problem types (-1, 1, 6 to 25)
