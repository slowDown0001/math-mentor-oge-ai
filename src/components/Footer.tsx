        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="#" className="text-gray-600 hover:text-primary transition-colors">Учебные планы</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="#" className="text-gray-600 hover:text-primary transition-colors">Контакты</Link></li>
            </ul>
          </div>
