...
const ChatSection = () => {
  const [messages, setMessages] = useState<Message[]>([
    { id: 1, text: "Hi! I'm your AI Math Tutor. Let's check your level first!", isUser: false, timestamp: new Date() },
    { id: 2, text: "Would you like to take a placement test or try some practice problems?", isUser: false, timestamp: new Date() },
  ]);
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="bg-white shadow-lg rounded-xl overflow-hidden border-0">
            <div className="bg-primary p-4">
              <h3 className="text-white font-medium">Math Mentor AI</h3>
            </div>
