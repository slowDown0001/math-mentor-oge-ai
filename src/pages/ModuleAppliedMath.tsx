...
const ModuleAppliedMath = () => {
  const navigate = useNavigate();
  const topics: TopicContent[] = [
    {
      id: "data-graphs",
      title: "Работа с данными и графиками",
      videos: 3,
      articles: 1,
      exercises: 3
    },
    {
      id: "applied-geometry",
      title: "Прикладная геометрия / Чтение и анализ графических схем",
      videos: 3,
      articles: 1,
      exercises: 3
    }
  ...
  orderedContent.push({ type: 'quiz', content: { id: 'module-test', title: 'Итоговый тест модуля', description: 'Проверьте свои знания по всему модулю "Применение математики к прикладным задачам"' }, index: 1 });
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              Модуль 9: Применение математики к прикладным задачам
            </h1>
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            <span className="text-lg font-semibold text-gray-700 dark:text-gray-300">900 возможных баллов мастерства</span>
            <Info className="h-4 w-4 text-gray-500" />
          </div>
          
          <div className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Навыки: Анализ данных, Графики, Таблицы, Прикладная геометрия
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {/* Topic 1: Работа с данными (3 exercises) */}
            ...
            {/* Topic 2: Прикладная геометрия (3 exercises) */}
            <div className="w-8 h-8 border-2 border-gray-300 rounded bg-white"></div>
            <div className="w-8 h-8 border-2 border-gray-300 rounded bg-white"></div>
            <div className="w-8 h-8 border-2 border-gray-300 rounded bg-white"></div>
...
export default ModuleAppliedMath;