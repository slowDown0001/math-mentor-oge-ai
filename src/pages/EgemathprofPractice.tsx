...
const EgemathprofPractice = () => {
  const questionTypes = [
    {
      title: "По номеру вопроса",
      description: "Практика всех вопросов выбранного номера (1-19)",
      icon: Hash,
      link: "/practice-by-number-egeprofmath",
      ...
      <div className="pt-8 container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Практика ЕГЭ Профильная Математика</h1>
...
export default EgemathprofPractice;