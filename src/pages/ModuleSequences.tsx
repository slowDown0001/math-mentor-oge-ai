...
const ModuleSequences = () => {
  ...
  const topics: TopicContent[] = [
    ...
    {
      id: "progressions",
      title: "Арифметическая и геометрическая прогрессии. Формула сложных процентов",
      videos: 3,
      articles: 1,
      exercises: 3
    }
  ...
  orderedContent.push({ type: 'quiz', content: { id: 'module-test', title: 'Итоговый тест модуля', description: 'Проверьте свои знания по всему модулю "Числовые последовательности"' }, index: 1 });
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Навыки: Последовательности, Прогрессии, Сложные проценты
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {/* Topic 1: Последовательности (3 exercises) */}
            ...
            {/* Topic 2: Прогрессии (3 exercises) */}
            <div className="w-8 h-8 border-2 border-gray-300 rounded bg-white"></div>
            <div className="w-8 h-8 border-2 border-gray-300 rounded bg-white"></div>
            <div className="w-8 h-8 border-2 border-gray-300 rounded bg-white"></div>
...
export default ModuleSequences;