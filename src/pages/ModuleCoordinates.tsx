...
const ModuleCoordinates = () => {
  ...
  orderedContent.push({ type: 'quiz', content: { id: 'module-test', title: 'Итоговый тест модуля', description: 'Проверьте свои знания по всему модулю "Координаты на прямой и плоскости"' }, index: 1 });
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              Модуль 6: Координаты на прямой и плоскости
            </h1>
        ...
        >
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Навыки: Координатная прямая, Декартовы координаты, Расстояния, Модули
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {/* Topic 1: Координатная прямая (3 exercises) */}
            ...
            {/* Topic 2: Декартовы координаты (3 exercises) */}
            <div className="w-8 h-8 border-2 border-gray-300 rounded bg-white"></div>
            <div className="w-8 h-8 border-2 border-gray-300 rounded bg-white"></div>
            <div className="w-8 h-8 border-2 border-gray-300 rounded bg-white"></div>
...
export default ModuleCoordinates;