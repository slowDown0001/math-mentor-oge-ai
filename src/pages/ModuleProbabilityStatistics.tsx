...
const ModuleProbabilityStatistics = () => {
  ...
  const topicMapping = ['8.1', '8.2', '8.3', '8.4', '8.5'];
  ...
  orderedContent.push({ type: 'quiz', content: { id: 'module-test', title: 'Итоговый тест модуля', description: 'Проверьте свои знания по всему модулю "Вероятность и статистика"' }, index: 1 });
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <div>
            <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              Модуль 8: Вероятность и статистика
            </h1>
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            <span className="text-lg font-semibold text-gray-700 dark:text-gray-300">2,250 возможных баллов мастерства</span>
            <Info className="h-4 w-4 text-gray-500" />
          </div>
          
          <div className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Навыки: Статистика, Вероятность, Комбинаторика, Множества, Графы
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {/* All 15 exercises as white squares */}
...
export default ModuleProbabilityStatistics;