      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="relative flex items-center justify-center">
            ...
            <button onClick={() => navigate('/ogemath')} className="absolute left-0 flex items-center gap-2 transition-colors text-lg font-normal rounded-md bg-slate-50 text-slate-900">
