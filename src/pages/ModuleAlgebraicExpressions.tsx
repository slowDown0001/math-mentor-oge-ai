...
const ModuleAlgebraicExpressions = () => {
  ...
  orderedContent.push({ type: 'quiz', content: { id: 'module-test', title: 'Итоговый тест модуля', description: 'Проверьте свои знания по всему модулю "Алгебраические выражения"' }, index: 2 });
