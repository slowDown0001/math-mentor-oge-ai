...
const ModuleFunctions = () => {
  ...
  const topics: TopicContent[] = [
    {
      id: "functions-properties",
      title: "Свойства и графики функций",
      videos: 3,
      articles: 1,
      exercises: 3
    }
  ...
  orderedContent.push({ type: 'quiz', content: { id: 'module-test', title: 'Итоговый тест модуля', description: 'Проверьте свои знания по всему модулю "Функции"' }, index: 1 });
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              1 тема • 3 видео • 1 статья • 3 упражнения
            </p>
          </div>
          <StreakDisplay />
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            <span className="text-lg font-semibold text-gray-700 dark:text-gray-300">450 возможных баллов мастерства</span>
            <Info className="h-4 w-4 text-gray-500" />
          </div>
          
          <div className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Навыки: Свойства функций, Графики, Область определения, Монотонность
          </div>
