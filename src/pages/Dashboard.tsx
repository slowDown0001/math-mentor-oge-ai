...
\\begin{array}{l}
\\textbf{\\textit{🔥 Ну что, поехали дальше! Сегодня у нас: Признаки подобия треугольников}} \\
\\\\
\\text{Ты уже прошёл(а) немало тем — движемся по плану как по рельсам 🚂} \\
\\text{Сегодняшняя тема важная и частая в ОГЭ, так что разложим всё по полочкам:} \\
\\\\
\\text{\quad 📘 \\underline{\\textcolor{#10b981}{\\href{/textbook2}{Изучить теорию}}} — разберись в признаках и основах} \\
\\text{\quad 🎥 \\underline{\\textcolor{#10b981}{\\href{/videos}{Посмотри видео}}} — объясняю всё на простых примерах} \\
\\text{\quad 🧠 \\underline{\\textcolor{#10b981}{\\href{/videos?style=brainrot}{Или включи brainrot-видео}}} — если хочется учиться под мемчики 😏} \\
\\text{\quad ✍️ \\underline{\\textcolor{#10b981}{\\href{/practice}{Попрактикуйся на задачах}}} — сначала простые, потом ОГЭ-уровень} \\
\\\\
\\textbf{\\textit{🎯 И, как всегда, обязательная часть дня:}} \\
\\text{\quad 🔎 \\underline{\\textcolor{#10b981}{\\href{/fipi-bank}{Банк заданий ФИПИ}}} — это топ-инструмент для подготовки.} \\
\\text{Решай хотя бы 1–2 задачи каждый день — и ты реально будешь на голову выше остальных 💪} \\
\\\\
\\text{Начни с теории — дальше всё пойдёт как по маслу. Если что — я рядом 😉} \\
\\end{array}
\\]`;
      }
