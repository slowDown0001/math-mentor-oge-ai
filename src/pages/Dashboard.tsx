  ...
  useEffect(() => {
    if (messages.length === 0 && !isLoading && topicProgress.length > 0) {
      ...
      if (topicsToImprove.length > 0) {
        ...
        recommendationMessage = `**Рекомендую сегодня изучить: Признаки подобия треугольников**

📖 <a href="/textbook2" style="color: #2563eb; text-decoration: underline;">Изучить теорию</a> - основные понятия и признаки
📺 <a href="/videos" style="color: #2563eb; text-decoration: underline;">Посмотреть видеоурок</a> - подробное объяснение с примерами  
📝 <a href="/practice" style="color: #2563eb; text-decoration: underline;">Решать задачи</a> - практические упражнения
🏦 <a href="/fipi-bank" style="color: #2563eb; text-decoration: underline;">Банк заданий ФИПИ</a> - официальные задачи по этой теме

Начни с теории, затем посмотри видео и переходи к практике! 🚀`;
      }
