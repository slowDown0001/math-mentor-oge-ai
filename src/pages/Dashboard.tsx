  ...
  useEffect(() => {
    if (messages.length === 0 && !isLoading && topicProgress.length > 0) {
      ...
      if (topicsToImprove.length > 0) {
        ...
        recommendationMessage = `const recommendationMessage = `
<p>🔥 <strong>Ну что, поехали дальше! Сегодня у нас: <em>Признаки подобия треугольников</em></strong></p>

<p>Ты уже прошёл(а) немало тем — движемся по плану как по рельсам 🚂<br/>
Сегодняшняя тема важная и частая в ОГЭ, так что разложим всё по полочкам:</p>

<ul style="margin-left: 1em;">
  <li>📘 <a href="/textbook2" class="text-emerald-600 underline">Изучить теорию</a> — разберись в признаках и основах</li>
  <li>🎥 <a href="/videos" class="text-emerald-600 underline">Посмотри видео</a> — объясняю всё на простых примерах</li>
  <li>🧠 <a href="/videos?style=brainrot" class="text-emerald-600 underline">Включи brainrot-видео</a>, если хочется учиться под мемчики 😏</li>
  <li>✍️ <a href="/practice" class="text-emerald-600 underline">Попрактикуйся на задачах</a> — сначала простые, потом ОГЭ-уровень</li>
</ul>

<p><strong>🎯 И, как всегда, обязательная часть дня:</strong></p>

<ul style="margin-left: 1em;">
  <li>🔎 <a href="/fipi-bank" class="text-emerald-600 underline">Банк заданий ФИПИ</a> — топ-инструмент для подготовки. Решай хотя бы 1–2 задачи каждый день — и ты реально будешь на голову выше остальных 💪</li>
</ul>
