...
Это степени, у которых показатель — дробь. Например, \\( a^{\\frac{1}{2}} \\) или \\( a^{-\\frac{3}{4}} \\). $$a^{\frac{1}{2}}, a^{\frac{3}{4}}, a^{-\frac{2}{3}}$$
...
Пример 1: $16^{\frac{3}{2}}$

Решение: $16^{\frac{3}{2}} = \left( \sqrt{16} \right)^3 = 4^3 = 64$
